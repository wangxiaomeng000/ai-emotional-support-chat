...
export type AIServiceType = 'openai' | 'openai-vision' | 'openrouter' | 'qianwen' | 'wenxin' | 'gemini' | 'siliconflow' | 'freevision' | 'real-vision' | 'huggingface' | 'real-image' | 'deepseek-vision';
